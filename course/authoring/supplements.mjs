...
[2,'For iid data with finitevarianceσ²,Σ(Xi−Xbar)²/n has expectation:',['σ²','nσ²/(n−1)','(n−1)σ²/n','0'],2,'The centered sum has expectation(n−1)σ².'],
...
[5,'Positive probability on the diagonalU=V with continuous marginals necessarily implies:',['A fixed joint point atom','No ordinary density can represent the entire joint law','Independence','Discrete marginals'],1,'Diagonal has planarLebesguemeasure0;positive mass there is singular,not necessarily a point atom.'],
...
[5,'For iid normaldata,√n(Xbar−μ)/S has:',['Normal law exactly','t withn df','t withn−1 df','F with1,n df'],2,'Independentnormal/chi-square construction uses residualdfn−1.'],
...
[7,'Under matching two-group normal equalvariance assumptions,ANOVA F equals:',['t','|t|','t²','2t²'],2,'BetweenSS divided bypooledMSE equals the squaredpooledt statistic.']
];
