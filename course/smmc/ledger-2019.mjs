// SMMC 2019 crosswalk — authored from the official 2019 problem/solution material.
// Problem statements are summarized rather than reproduced.

export default [
  {
    id: "SMMC-2019-A1",
    year: 2019, session: "A", problem: 1, eastRelevant: true,
    synopsis: "A prime-factor-driven integer recurrence; prove that the product of the 2019 smallest primes appears as a term.",
    primaryDomain: "S4",
    secondaryTags: ["PRIME", "REC"],
    methodTags: ["INDUCTION", "RECURRENCE-REFORMULATION", "MINIMAL-COUNTEREXAMPLE"],
    t25Sessions: [8, 19],
    t25Bridges: ["BR-I", "BR-N"],
    overlap: "amber",
    bridgeNeeds: ["Prime-factor support of an integer and square-free product language", "Elementary prime-gap/minimal-not-divisible reasoning"],
  ...
  {
    id: "SMMC-2019-A2",
    year: 2019, session: "A", problem: 2, eastRelevant: true,
    ...
    methodTags: ["INDUCTION", "EXCHANGE-ARGUMENT", "FACTORIZATION", "MONOTONICITY"],
    t25Sessions: [8, 14, 28, 29],
    t25Bridges: ["BR-I"],
    overlap: "amber",
    bridgeNeeds: ["Adjacent-swap exchange arguments for permutation optimization"],
    assessmentRole: "transfer",
    classificationConfidence: "high",
  ...
  {
    id: "SMMC-2019-A3",
    year: 2019, session: "A", problem: 3, eastRelevant: true,
    ...
    primaryDomain: "S6",
    secondaryTags: ["POLY", "MOD", "PRIME"],
    methodTags: ["FACTORIZATION", "CASE-DECOMPOSITION", "CROSS-DOMAIN"],
    t25Sessions: [12, 27, 28, 30, 31],
    t25Bridges: ["BR-N"],
    overlap: "amber",
    bridgeNeeds: ["Rational-root theorem at contest depth", "Modular reduction of an integer polynomial identity"],
    assessmentRole: "transfer",
    classificationConfidence: "high",
  ...
  {
    id: "SMMC-2019-A4",
    year: 2019, session: "A", problem: 4, eastRelevant: true,
    ...
    primaryDomain: "S3",
    secondaryTags: ["SEQ", "SERIES", "ASYM"],
    methodTags: ["COUNTEREXAMPLE", "CONSTRUCTION", "BOUNDING", "CASE-DECOMPOSITION"],
    t25Sessions: [15, 18, 19],
    t25Bridges: [],
    overlap: "red",
    bridgeNeeds: ["General positive-series convergence and comparison tests", "Purpose-built block/scale counterexample construction", "Logarithmic asymptotic estimates beyond T25 sequence limits"],
  ...
  {
    id: "SMMC-2019-B1",
    year: 2019, session: "B", problem: 1, eastRelevant: true,
    ...
    primaryDomain: "S3",
    secondaryTags: ["INT", "INEQ"],
    methodTags: ["FACTORIZATION", "CASE-DECOMPOSITION", "OPTIMIZATION", "BOUNDING"],
    t25Sessions: [4, 63, 73],
    t25Bridges: [],
    overlap: "green",
    bridgeNeeds: [],
  ...
  {
    id: "SMMC-2019-B2",
    year: 2019, session: "B", problem: 2, eastRelevant: true,
    synopsis: "Prove a factorial expression involving the floor of (p-1)!/e is divisible by every odd prime p.",
    primaryDomain: "S4",
    secondaryTags: ["PRIME", "MOD", "SERIES", "ASYM"],
    methodTags: ["BOUNDING", "FACTORIZATION", "CROSS-DOMAIN"],
    t25Sessions: [15, 72],
    t25Bridges: ["BR-N"],
    overlap: "red",
    bridgeNeeds: ["Alternating infinite-series expansion and remainder control", "Factorial congruence manipulation modulo a prime", "Legality of modular cancellation by nonzero residues"],
    assessmentRole: "development",
    classificationConfidence: "high",
  ...
  {
    id: "SMMC-2019-B3",
    year: 2019, session: "B", problem: 3, eastRelevant: true,
    ...
    primaryDomain: "S2",
    secondaryTags: ["GRAPH", "INEQ", "CONVEX"],
    methodTags: ["SMOOTHING", "EXTREMAL", "CONSTRUCTION", "BOUNDING", "SYMMETRY"],
    t25Sessions: [16, 17],
    t25Bridges: [],
    overlap: "red",
    bridgeNeeds: ["Finite graph and clique vocabulary", "Mass-shifting/compression on nonadjacent vertices", "Extremal graph-optimization reasoning"],
    assessmentRole: "development",
    classificationConfidence: "high",
  ...
  {
    id: "SMMC-2019-B4",
    year: 2019, session: "B", problem: 4, eastRelevant: true,
    ...
    primaryDomain: "S2",
    secondaryTags: ["REC", "ASYM", "CONST"],
    methodTags: ["CONSTRUCTION", "RECURRENCE-REFORMULATION", "BOUNDING", "AUXILIARY-OBJECT", "INDUCTION"],
    t25Sessions: [15, 18, 19, 29, 30],
    t25Bridges: ["BR-I"],
    overlap: "red",
    bridgeNeeds: ["Recurrence-growth bounds via characteristic roots", "Injective/surjective combinatorial encodings", "Forbidden-pattern counting", "Research-style partial-progress discipline for the open part"],
