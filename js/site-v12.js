...
try {
  await import("./data/t22-quant-research.js?v=1.2.2");
} catch (error) {
...
// currently loaded registry (for example, T22 saved during a stale mixed-cache
// session). app.js assumes the persisted terminal exists, so clear only this
// invalid selector value and preserve all progress data.
try {
...
await import("./app.js?v=1.2.2");
await import("./vault.js?v=1.2.2");
