...
const moduleId = "ARC537";
const expectedIds = [
  "T22-M29-A01", "T22-M29-A02", "T22-M29-A03", "T22-M29-A04", "T22-M29-A05",
  "T22-M29-A06", "T22-M29-A07", "T22-M29-A08", "T22-M29-A09",
];
...
expect(Boolean(WORLD.terminals.find((terminal) => terminal.id === "T22")), "T22 terminal must be loaded before M29 validation.");
...
if (errors.length) {
  console.error(`T22 M29 rich validation failed with ${errors.length} issue(s):`);
  for (const error of errors) console.error(`- ${error}`);
  process.exit(1);
}
console.log(`T22 M29 rich syllabus OK: ${expectedIds.length} stable mission cards validated.`);
