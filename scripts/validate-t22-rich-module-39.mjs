...
expect(richModule?.arcs?.["T22-M39-A06"]?.requiredMastery?.some((item) => item.includes("deterministic") && item.includes("history dependence")), "M39 A06 must separate deterministic time variation from history dependence.");
