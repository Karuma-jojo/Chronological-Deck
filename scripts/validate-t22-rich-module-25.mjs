...
const moduleId = "ARC539";
const expectedIds = [
  "T22-M25-A01", "T22-M25-A02", "T22-M25-A03", "T22-M25-A04", "T22-M25-A05",
  "T22-M25-A06", "T22-M25-A07", "T22-M25-A08", "T22-M25-A09", "T22-M25-A10",
  "T22-M25-A11", "T22-M25-A12", "T22-M25-A13", "T22-M25-A14", "T22-M25-A15",
];
...
expect(Boolean(WORLD.terminals.find((terminal) => terminal.id === "T22")), "T22 terminal must be loaded before M25 validation.");
...
if (errors.length) {
  console.error(`T22 M25 rich validation failed with ${errors.length} issue(s):`);
  for (const error of errors) console.error(`- ${error}`);
  process.exit(1);
}
console.log(`T22 M25 rich syllabus OK: ${expectedIds.length} stable mission cards validated.`);
