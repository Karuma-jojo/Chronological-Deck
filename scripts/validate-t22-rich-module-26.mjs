...
const moduleId = "ARC531";
const expectedIds = [
  "T22-M26-A01", "T22-M26-A02", "T22-M26-A03", "T22-M26-A04", "T22-M26-A05",
  "T22-M26-A06", "T22-M26-A07", "T22-M26-A08", "T22-M26-A09", "T22-M26-A10",
];
...
expect(Boolean(WORLD.terminals.find((terminal) => terminal.id === "T22")), "T22 terminal must be loaded before M26 validation.");
...
if (errors.length) {
  console.error(`T22 M26 rich validation failed with ${errors.length} issue(s):`);
  for (const error of errors) console.error(`- ${error}`);
  process.exit(1);
}
console.log(`T22 M26 rich syllabus OK: ${expectedIds.length} stable mission cards validated.`);
