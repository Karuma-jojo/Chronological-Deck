...
const moduleId = "ARC534";
const expectedIds = [
  "T22-M28-A01", "T22-M28-A02", "T22-M28-A03", "T22-M28-A04",
  "T22-M28-A05", "T22-M28-A06", "T22-M28-A07", "T22-M28-A08",
];
...
expect(Boolean(WORLD.terminals.find((terminal) => terminal.id === "T22")), "T22 terminal must be loaded before M28 validation.");
...
if (errors.length) {
  console.error(`T22 M28 rich validation failed with ${errors.length} issue(s):`);
  for (const error of errors) console.error(`- ${error}`);
  process.exit(1);
}
console.log(`T22 M28 rich syllabus OK: ${expectedIds.length} stable mission cards validated.`);
