...
expect(SMMC_UNITS_V1.length === 10, "Expected ten authored SMMC units.");
expect(Object.keys(SMMC_PUBLIC_PROBLEMS_V1).length === 20, "Expected twenty authored public problems.");
expect(Object.keys(SMMC_EVALUATOR_V1).length === 20, "Expected twenty authored evaluator references.");
