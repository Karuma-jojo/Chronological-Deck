...
expect(Object.keys(SMMC_PUBLIC_PROBLEMS_V1).length === 12, "Expected twelve authored public problems.");
expect(Object.keys(SMMC_EVALUATOR_V1).length === 12, "Expected twelve authored evaluator references.");
