...
console.log('PASS M11 handoff: historical unpublished validation receipt preserved; current ARC510 status is registered for the authorized publication route through M12; no learner-mastery overclaim.');
