...
assert(meta.version.startsWith('T22E-course-0.9.'),'course metadata must include the later-authorized M08 candidate while preserving M06');
...
assert(!meta.moduleSources.some(x=>x.order>=10),'M10 must remain unloaded');
