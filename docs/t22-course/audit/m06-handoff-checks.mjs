...
assert(meta.version.startsWith('T22E-course-0.12.'),'course metadata must preserve M06 while allowing the authorized route through M12');
...
assert.equal(meta.moduleSources.length,12,'later-authorized publication through M12 must not disturb M06 evidence');
