...
assert(fs.existsSync('course/t22/authoring/m08.json'),'M08 is now explicitly authorized after this historical M05 checkpoint');
...
console.log('PASS: M05 handoff matches 24/48/120 repair state, exact claim/rubric mapping, shared evidence key, later-authorized M07/M08 presence while the M05 acceptance state remains pinned.');
