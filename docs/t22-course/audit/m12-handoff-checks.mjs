...
assert.match(handoff,/builder-validated candidate; unpublished; awaiting separate independent pedagogical review\/acceptance/i);
...
console.log('PASS M12 handoff: builder-validated/unpublished state, source/boundary repairs, 19/38/58 evidence counts, implementation-head workflow and explicit independent-review stop boundary are documented without claiming acceptance.');
